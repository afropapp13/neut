...
make_q2hists_20deg()
{
  ...
  fill_q2hists("neut_minerva_numu.root",
			   "hists_neut_minerva_numu_20deg.root",
			   rate_numu);

  fill_q2hists("neut_minerva_numubar.root",
			   "hists_neut_minerva_numubar_20deg.root",
			   rate_numubar);

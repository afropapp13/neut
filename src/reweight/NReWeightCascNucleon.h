...
\class    neut::rew::NReWeightCascNucleon
...
#ifndef _N_REWEIGHT_CASC_NUCLEON_H_
#define _N_REWEIGHT_CASC_NUCLEON_H_
...
namespace rew   {
 ...
 class NReWeightCascNucleon : public NReWeightI 
 {
 public:
   NReWeightCascNucleon();
  ~NReWeightCascNucleon();
 ...
 private:
   ...
   double fDoublePiProbTwkDial;

   double fTotalProbDef; 
   double fElasticProbDef;
   double fSinglePiProbDef;
   double fDoublePiProbDef;

   double fTotalProbCurr; 

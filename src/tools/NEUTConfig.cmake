...
pkg_check_modules(PC_NEUT QUIET NEUT)

find_path(NEUT_INCLUDE_DIR
  NAMES necardC.h
  PATHS ${PC_NEUT_INCLUDE_DIRS}
)
...
find_library(NEUT_LIBRARY_DIR
  NAMES libNEUT.a
  PATHS ${PC_NEUT_LIBRARY_DIRS}
)

set(NEUT_VERSION ${PC_NEUT_VERSION})

include(FindPackageHandleStandardArgs)
find_package_handle_standard_args(NEUT
    REQUIRED_VARS NEUT_INCLUDE_DIR NEUT_LIBRARY_DIR
...
if(NEUT_FOUND)
  ...
  cmessage(STATUS "    INCLUDE_DIRECTORIES: ${NEUT_INCLUDE_DIR}")
  cmessage(STATUS "    LINK_DIRECTORIES: ${NEUT_LIBRARY_DIR}")
  cmessage(STATUS "    LINK_LIBRARIES: ${PC_NEUT_LIBRARIES}")
  cmessage(STATUS "    LDFLAGS: ${PC_NEUT_LDFLAGS}")
  cmessage(STATUS "    LDFLAGS_OTHER: ${PC_NEUT_LDFLAGS_OTHER}")
  cmessage(STATUS "    CFLAGS: ${PC_NEUT_CFLAGS}")
  cmessage(STATUS "    CFLAGS_OTHER: ${PC_NEUT_CFLAGS_OTHER}")
  cmessage(STATUS "    NEUT_EXE_LINKFLAGS: ${NEUT_EXE_LINKFLAGS}")

  #This horrow show lets us add the exe-flag only for executable targets.
  SET(NEUT_LINK_OPTIONS ${PC_NEUT_LDFLAGS_OTHER})
  ...
  if(NOT TARGET NEUT::Core)
      ...
      set_target_properties(NEUT::Core PROPERTIES
          INTERFACE_INCLUDE_DIRECTORIES "${PC_NEUT_INCLUDE_DIRS}"
          INTERFACE_COMPILE_OPTIONS "${PC_NEUT_CFLAGS_OTHER}"
          INTERFACE_LINK_DIRECTORIES "${PC_NEUT_LIBRARY_DIRS}"
          INTERFACE_LINK_LIBRARIES "${PC_NEUT_LIBRARIES}"

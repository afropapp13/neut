...
void read_RES_params(toml::value const &RES_table) {
  toml_h::set_option_if_present(
      neut1pi_.neiff, RES_table, "form_factors",
      std::map<std::string, int>{{"rein_sehgal", 0}, {"graczyk_sobczyk", 1}});

  toml_h::set_option_if_present_rec(neut1pi_.nenrtype, RES_table,
                                    {"rein_sehgal", "nr_type"},
                                    std::map<std::string, int>{
                                        {"original", 0},
                                        {"halved", 1},
  ...
  toml_h::set_if_present_rec(neut1pi_.xmarsres, RES_table,
                             {"rein_sehgal", "axial_mass"});

  toml_h::set_if_present(neut1pi_.rnebgscl, RES_table,
                         "nonresonant_background_scale");

  toml_h::set_if_present_rec(neut1pi_.xmvrsres, RES_table,
                             {"rein_sehgal", "vector_mass"});

  toml_h::set_if_present_rec(neut1pi_.xmanffres, RES_table,
                             {"graczyk_sobczyk", "axial_mass"});
  toml_h::set_if_present_rec(neut1pi_.xmvnffres, RES_table,
                             {"graczyk_sobczyk", "vector_mass"});
  toml_h::set_if_present_rec(neut1pi_.rneca5i, RES_table,
                             {"graczyk_sobczyk", "ca5"});
}

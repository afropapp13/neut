...
void xsec_im13_(float *diff_Xsec, float *Wf, float *Qf, float *Ef, float *tf, float *phif, float *lepmass) {
  ...
  double V_1 =  sqrt_chk(2.)*(g_A*M/f_pi)*2.*FF_1*FV_cut*(1./(W*W - M*M))   +  sqrt_chk(2.)*(g_A/f_pi)*(FF_2*FV_cut/M) ;
  double V_2 =  sqrt_chk(2.)*(g_A*M/f_pi)*(2.*FF_1*FV_cut/qk)*(1./(W*W - M*M));  
  double V_3 = -sqrt_chk(2.)*(g_A/f_pi)*(2.*FF_2*FV_cut)*(1./(W*W - M*M) ); 
  double V_4 = -sqrt_chk(2.)*(g_A/f_pi)*(2.*FF_2*FV_cut)*(1./(W*W - M*M)); 
  ...
  double A_1 = - sqrt_chk(2.)*(g_A*M/f_pi)*FF_A*FA_cut*(1./(W*W - M*M)) ; 
  double A_3 = - sqrt_chk(2.)*(g_A*M/f_pi)*FF_A*FA_cut*(1./(W*W - M*M)) ; 
  double A_4 = (1./sqrt_chk(2.))*(1./f_pi)*(FA_cut/M)*(g_A*FF_A - F_rho);
  double A_7 = - sqrt_chk(2.)*(g_A*M/f_pi)*FF_A*FA_cut*(1./(Q + m_pi*m_pi));
  double A_8 = - (1./sqrt_chk(2.))*(g_A/f_pi)*FF_A*FA_cut*(1./(Q + m_pi*m_pi))*(1. + 4.*M*M/(W*W - M*M))
  ...
  for (int i=0; i<nRes; i++){
    ...
    ///////////////////////////////////////////////////////////////////////////////////////////
    //XSEC  ...      dsigma/dQ2 dW dcostheta dphi

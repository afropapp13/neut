...
void xsec_im12_(float *diff_Xsec, float *Wf, float *Qf, float *Ef, float *tf, float *phif, float *lepmass) {
  ...
  double V_1 = (g_A*M/f_pi)*2.*FF_1*FV_cut*(1./(W*W - M*M)) - (g_A*M/f_pi)*(2.*FF_1*FV_cut)*(1./(m_pi*m_pi - 2.*q_0*p_10 - 2.*abs_mom_q*abs_mom_k*t)); 
  double V_2 = (g_A*M/f_pi)*(2.*FF_1*FV_cut/qk)*(1./(W*W - M*M)) - (g_A*M/f_pi)*(2.*FF_1*FV_cut/qk)*(1./(m_pi*m_pi - 2.*q_0*p_10 - 2.*abs_mom_q*abs_mom_k*t));
  double V_3 = -(g_A/f_pi)*(2.*FF_2*FV_cut)*(1./(W*W - M*M)) - (g_A*M/f_pi)*(2.*FF_2*FV_cut/M)*(1./(m_pi*m_pi - 2.*q_0*p_10 - 2.*abs_mom_q*abs_mom_k*t));
  double V_4 = -(g_A/f_pi)*(2.*FF_2*FV_cut)*(1./(W*W - M*M)) + (g_A*M/f_pi)*(2.*FF_2*FV_cut/M)*(1./(m_pi*m_pi - 2.*q_0*p_10 - 2.*abs_mom_q*abs_mom_k*t));
  double V_5 = 2.*(g_A*M/f_pi)*(FF_pi*FV_cut/qk)*(1./(Q+2.*qk)) ;
  ...
  double A_1 = -(g_A*M/f_pi)*FF_A*FA_cut*( 1./(m_pi*m_pi - 2.*q_0*p_10 - 2.*abs_mom_q*abs_mom_k*t))
    - (g_A*M/f_pi)*FF_A*FA_cut*(1./(W*W - M*M));  
  double A_3 =  (g_A*M/f_pi)*FF_A*FA_cut*( 1./(m_pi*m_pi - 2.*q_0*p_10 - 2.*abs_mom_q*abs_mom_k*t))
    - (g_A*M/f_pi)*FF_A*FA_cut*(1./(W*W - M*M)) ; 
  double A_4 = -(1./2.)*(1./f_pi)*(FA_cut/M)*(-g_A*FF_A + F_rho)
    + (1./2.)*(1./f_pi)*(FA_cut/M)*(g_A*FF_A - F_rho);
  double A_7 = 0.;
  double A_8 =  -(1./2.)*(g_A/f_pi)*FF_A*FA_cut*(1./(Q + m_pi*m_pi))*(1. +  4.*M*M/(m_pi*m_pi - 2.*q_0*p_10 - 2.*abs_mom_q*abs_mom_k*t))
    + (1./2.)*(1./f_pi)*(1./(Q + m_pi*m_pi))*F_rho*FA_cut
    - (1./2.)*(g_A/f_pi)*FF_A*FA_cut*(1./(Q + m_pi*m_pi))*(1. + 4.*M*M/(W*W - M*M))
    + (1./2.)*(1. /f_pi)*(1./(Q + m_pi*m_pi))*F_rho*FA_cut; 
  ...
  for (int i=0; i<nRes; i++){
    ...
    double Vsum1Re_0P11  = HV0_realP11[1]* d111 + HV0_realP11[2]* d311 + HV0_realP11[3]* d111 + HV0_realP11[5]* d111 + HV0_realP11[6]* d511 + HV0_realP11[7]* d511 + HV0_realP11[8]* d311 + HV0_realP11[10]* d111 + HV0_realP11[11]*d311;
    double Vsum1Re_0P_11 = HV0_realP_11[1]*d11_1+ HV0_realP_11[2]*d31_1+ HV0_realP_11[3]*d11_1+ HV0_realP_11[5]*d11_1+ HV0_realP_11[6]*d51_1+ HV0_realP_11[7]*d51_1+ HV0_realP_11[8]*d31_1+ HV0_realP_11[10]*d11_1+ HV0_realP_11[11]*d31_1;
    double Vsum1Re_0P1_1 = HV0_realP1_1[1]*d11_1+ HV0_realP1_1[2]*d31_1+ HV0_realP1_1[3]*d11_1+ HV0_realP1_1[5]*d11_1+ HV0_realP1_1[6]*d51_1+ HV0_realP1_1[7]*d51_1+ HV0_realP1_1[8]*d31_1+ HV0_realP1_1[10]*d11_1+ HV0_realP1_1[11]*d31_1;
    double Vsum1Re_0P_1_1= HV0_realP_1_1[1]*d111+ HV0_realP_1_1[2]*d311+ HV0_realP_1_1[3]*d111+ HV0_realP_1_1[5]*d111+ HV0_realP_1_1[6]*d511+ HV0_realP_1_1[7]*d511+ HV0_realP_1_1[8]*d311+ HV0_realP_1_1[10]*d111+ HV0_realP_1_1[11]*d311;
    ...
    double Vsum1Im_0P11  = HV0_ImP11[1]* d111 + HV0_ImP11[2]* d311 + HV0_ImP11[3]* d111 + HV0_ImP11[5]* d111 + HV0_ImP11[6]* d511 + HV0_ImP11[7]* d511 + HV0_ImP11[8]* d311 + HV0_ImP11[10]* d111 + HV0_ImP11[11]*d311;
    double Vsum1Im_0P_11 = HV0_ImP_11[1]*d11_1+ HV0_ImP_11[2]*d31_1+ HV0_ImP_11[3]*d11_1+ HV0_ImP_11[5]*d11_1+ HV0_ImP_11[6]*d51_1+ HV0_ImP_11[7]*d51_1+ HV0_ImP_11[8]*d31_1+ HV0_ImP_11[10]*d11_1+ HV0_ImP_11[11]*d31_1;
    double Vsum1Im_0P1_1 = HV0_ImP1_1[1]*d11_1+ HV0_ImP1_1[2]*d31_1+ HV0_ImP1_1[3]*d11_1+ HV0_ImP1_1[5]*d11_1+ HV0_ImP1_1[6]*d51_1+ HV0_ImP1_1[7]*d51_1+ HV0_ImP1_1[8]*d31_1+ HV0_ImP1_1[10]*d11_1+ HV0_ImP1_1[11]*d31_1;
    double Vsum1Im_0P_1_1= HV0_ImP_1_1[1]*d111+ HV0_ImP_1_1[2]*d311+ HV0_ImP_1_1[3]*d111+ HV0_ImP_1_1[5]*d111+ HV0_ImP_1_1[6]*d511+ HV0_ImP_1_1[7]*d511+ HV0_ImP_1_1[8]*d311+ HV0_ImP_1_1[10]*d111+ HV0_ImP_1_1[11]*d311; 
    ...
    double Asum1Re_0P11  = HA0_realP11[1]* d111 + HA0_realP11[2]* d311 + HA0_realP11[3]* d111 + HA0_realP11[5]* d111 + HA0_realP11[6]* d511 + HA0_realP11[7]* d511 + HA0_realP11[8]* d311 + HA0_realP11[10]* d111 + HA0_realP11[11]*d311;
    double Asum1Re_0P_11 = HA0_realP_11[1]*d11_1+ HA0_realP_11[2]*d31_1+ HA0_realP_11[3]*d11_1+ HA0_realP_11[5]*d11_1+ HA0_realP_11[6]*d51_1+ HA0_realP_11[7]*d51_1+ HA0_realP_11[8]*d31_1+ HA0_realP_11[10]*d11_1+ HA0_realP_11[11]*d31_1;
    double Asum1Re_0P1_1 = HA0_realP1_1[1]*d11_1+ HA0_realP1_1[2]*d31_1+ HA0_realP1_1[3]*d11_1+ HA0_realP1_1[5]*d11_1+ HA0_realP1_1[6]*d51_1+ HA0_realP1_1[7]*d51_1+ HA0_realP1_1[8]*d31_1+ HA0_realP1_1[10]*d11_1+ HA0_realP1_1[11]*d31_1;
    double Asum1Re_0P_1_1= HA0_realP_1_1[1]*d111+ HA0_realP_1_1[2]*d311+ HA0_realP_1_1[3]*d111+ HA0_realP_1_1[5]*d111+ HA0_realP_1_1[6]*d511+ HA0_realP_1_1[7]*d511+ HA0_realP_1_1[8]*d311+ HA0_realP_1_1[10]*d111+ HA0_realP_1_1[11]*d311;
    //Isospin 1/2 Immaginary
    ...
    double Asum1Im_0P11  = HA0_ImP11[1]* d111 + HA0_ImP11[2]* d311 + HA0_ImP11[3]* d111 + HA0_ImP11[5]* d111 + HA0_ImP11[6]* d511 + HA0_ImP11[7]* d511 + HA0_ImP11[8]* d311 + HA0_ImP11[10]* d111 + HA0_ImP11[11]*d311;
    double Asum1Im_0P_11 = HA0_ImP_11[1]*d11_1+ HA0_ImP_11[2]*d31_1+ HA0_ImP_11[3]*d11_1+ HA0_ImP_11[5]*d11_1+ HA0_ImP_11[6]*d51_1+ HA0_ImP_11[7]*d51_1+ HA0_ImP_11[8]*d31_1+ HA0_ImP_11[10]*d11_1+ HA0_ImP_11[11]*d31_1;
    double Asum1Im_0P1_1 = HA0_ImP1_1[1]*d11_1+ HA0_ImP1_1[2]*d31_1+ HA0_ImP1_1[3]*d11_1+ HA0_ImP1_1[5]*d11_1+ HA0_ImP1_1[6]*d51_1+ HA0_ImP1_1[7]*d51_1+ HA0_ImP1_1[8]*d31_1+ HA0_ImP1_1[10]*d11_1+ HA0_ImP1_1[11]*d31_1;
    double Asum1Im_0P_1_1= HA0_ImP_1_1[1]*d111+ HA0_ImP_1_1[2]*d311+ HA0_ImP_1_1[3]*d111+ HA0_ImP_1_1[5]*d111+ HA0_ImP_1_1[6]*d511+ HA0_ImP_1_1[7]*d511+ HA0_ImP_1_1[8]*d311+ HA0_ImP_1_1[10]*d111+ HA0_ImP_1_1[11]*d311;
    ...
    double sum1Re_0P11  = Vsum1Re_0P11  - Asum1Re_0P11;
    double sum1Re_0P_11 = Vsum1Re_0P_11 - Asum1Re_0P_11 ;
    double sum1Re_0P1_1 = Vsum1Re_0P1_1 - Asum1Re_0P1_1;
    double sum1Re_0P_1_1= Vsum1Re_0P_1_1- Asum1Re_0P_1_1 ;
    ...
    double sum1Im_0P11  = Vsum1Im_0P11  - Asum1Im_0P11;
    double sum1Im_0P_11 = Vsum1Im_0P_11 - Asum1Im_0P_11 ;
    double sum1Im_0P1_1 = Vsum1Im_0P1_1 - Asum1Im_0P1_1;
    double sum1Im_0P_1_1= Vsum1Im_0P_1_1- Asum1Im_0P_1_1 ;
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    *diff_Xsec = 
      ...
      *(  
          ...
          C_T_plus_square*( 
            ...
            +  pow( ((F_minus11   - G_minus11  ) + C3*sum3Re_M11 + C1*sum1Re_M11) , 2)
            +  pow( ((F_minus_11  - G_minus_11 ) + C3*sum3Re_M_11+ C1*sum1Re_M_11) , 2) 
            +  pow( ((F_minus1_1  - G_minus1_1 ) + C3*sum3Re_M1_1+ C1*sum1Re_M1_1 ) , 2)
            +  pow( ((F_minus_1_1 - G_minus_1_1) + C3*sum3Re_M_1_1+C1*sum1Re_M_1_1) , 2)
            )
          + C_T_minus_square*(
            ...
            +  pow( ((F_plus11   - G_plus11  ) + C3*sum3Re_P11  + C1*sum1Re_P11) , 2)
            +  pow( ((F_plus_11  - G_plus_11 ) + C3*sum3Re_P_11 + C1*sum1Re_P_11) , 2) 
            +  pow( ((F_plus1_1  - G_plus1_1 ) + C3*sum3Re_P1_1 + C1*sum1Re_P1_1 ) , 2)
            +  pow( ((F_plus_1_1 - G_plus_1_1) + C3*sum3Re_P_1_1+ C1*sum1Re_P_1_1 ) , 2)
            )
          + C_S_minus_square*(
              ...
              +  pow( ((F_zero_minus11   - G_zero_minus11  ) + C3*sum3Re_0M11  + C1*sum1Re_0M11) , 2)
              +  pow( ((F_zero_minus_11  - G_zero_minus_11 ) + C3*sum3Re_0M_11 + C1*sum1Re_0M_11) , 2) 
              +  pow( ((F_zero_minus1_1  - G_zero_minus1_1 ) + C3*sum3Re_0M1_1 + C1*sum1Re_0M1_1 ) , 2)
              +  pow( ((F_zero_minus_1_1 - G_zero_minus_1_1) + C3*sum3Re_0M_1_1+ C1*sum1Re_0M_1_1) , 2)
              )
          + C_S_plus_square*(
              ( C1*sum1Im_0P11  + C3*sum3Im_0P11  )*( C1*sum1Im_0P11  + C3*sum3Im_0P11)
              +  ( C1*sum1Im_0P_11 + C3*sum3Im_0P_11 )*( C1*sum1Im_0P_11 + C3*sum3Im_0P_11)
              +  ( C1*sum1Im_0P1_1 + C3*sum3Im_0P1_1 )*( C1*sum1Im_0P1_1 + C3*sum3Im_0P1_1)
              +  ( C1*sum1Im_0P_1_1+ C3*sum3Im_0P_1_1)*( C1*sum1Im_0P_1_1+ C3*sum3Im_0P_1_1)

              +  pow( ((F_zero_plus11   - G_zero_plus11  ) + C3*sum3Re_0P11  + C1*sum1Re_0P11) , 2)
              +  pow( ((F_zero_plus_11  - G_zero_plus_11 ) + C3*sum3Re_0P_11 + C1*sum1Re_0P_11) , 2) 
              +  pow( ((F_zero_plus1_1  - G_zero_plus1_1 ) + C3*sum3Re_0P1_1 + C1*sum1Re_0P1_1)  , 2)
              +  pow( ((F_zero_plus_1_1 - G_zero_plus_1_1) + C3*sum3Re_0P_1_1+ C1*sum1Re_0P_1_1)  , 2)
              )
          ...
          +2.*cos(phi)*(
              C_L_minus*sqrt_chk(C_S_minus_square)*( 
                ...
                +   ((F_minus11   - G_minus11  ) + C3*sum3Re_M11 + C1*sum1Re_M11)*((F_zero_minus11   - G_zero_minus11  ) + C3*sum3Re_0M11  + C1*sum1Re_0M11)
                +   ((F_minus_11  - G_minus_11 ) + C3*sum3Re_M_11+ C1*sum1Re_M_11)*((F_zero_minus_11  - G_zero_minus_11 ) + C3*sum3Re_0M_11 + C1*sum1Re_0M_11)
                +   ((F_minus1_1  - G_minus1_1 ) + C3*sum3Re_M1_1+ C1*sum1Re_M1_1)*((F_zero_minus1_1  - G_zero_minus1_1 ) + C3*sum3Re_0M1_1 + C1*sum1Re_0M1_1 )
                +   ((F_minus_1_1 - G_minus_1_1) + C3*sum3Re_M_1_1+C1*sum1Re_M_1_1)*((F_zero_minus_1_1 - G_zero_minus_1_1) + C3*sum3Re_0M_1_1+ C1*sum1Re_0M_1_1)
                )
              + C_R_minus*sqrt_chk(C_S_minus_square)  *( 
                ...
                +   ((F_plus11   - G_plus11  ) + C3*sum3Re_P11  + C1*sum1Re_P11) * ((F_zero_minus11   - G_zero_minus11  ) + C3*sum3Re_0M11  + C1*sum1Re_0M11) 
                +   ((F_plus_11  - G_plus_11 ) + C3*sum3Re_P_11 + C1*sum1Re_P_11)* ((F_zero_minus_11  - G_zero_minus_11 ) + C3*sum3Re_0M_11 + C1*sum1Re_0M_11)
                +   ((F_plus1_1  - G_plus1_1 ) + C3*sum3Re_P1_1 + C1*sum1Re_P1_1 )*((F_zero_minus1_1  - G_zero_minus1_1 ) + C3*sum3Re_0M1_1 + C1*sum1Re_0M1_1 ) 
                +   ((F_plus_1_1 - G_plus_1_1) + C3*sum3Re_P_1_1+ C1*sum1Re_P_1_1)*((F_zero_minus_1_1 - G_zero_minus_1_1) + C3*sum3Re_0M_1_1+ C1*sum1Re_0M_1_1)
                )
              + C_L_plus*sqrt_chk(C_S_plus_square)*( 
                  ( C1*sum1Im_M11 +  C3*sum3Im_M11)*( C1*sum1Im_0P11 +  C3*sum3Im_0P11)
                  +  ( C1*sum1Im_M_11 + C3*sum3Im_M_11)*( C1*sum1Im_0P_11 + C3*sum3Im_0P_11)
                  +  ( C1*sum1Im_M1_1 + C3*sum3Im_M1_1)*( C1*sum1Im_0P1_1 + C3*sum3Im_0P1_1)
                  +  ( C1*sum1Im_M_1_1 +C3*sum3Im_M_1_1)*( C1*sum1Im_0P_1_1 +C3*sum3Im_0P_1_1)

                  +   ((F_minus11   - G_minus11  ) + C3*sum3Re_M11 + C1*sum1Re_M11)*((F_zero_plus11   - G_zero_plus11  ) + C3*sum3Re_0P11  + C1*sum1Re_0P11)
                  +   ((F_minus_11  - G_minus_11 ) + C3*sum3Re_M_11+ C1*sum1Re_M_11)*((F_zero_plus_11  - G_zero_plus_11 ) + C3*sum3Re_0P_11 + C1*sum1Re_0P_11)
                  +   ((F_minus1_1  - G_minus1_1 ) + C3*sum3Re_M1_1+ C1*sum1Re_M1_1)*((F_zero_plus1_1  - G_zero_plus1_1 ) + C3*sum3Re_0P1_1 + C1*sum1Re_0P1_1 )
                  +   ((F_minus_1_1 - G_minus_1_1) + C3*sum3Re_M_1_1+C1*sum1Re_M_1_1)*((F_zero_plus_1_1 - G_zero_plus_1_1) + C3*sum3Re_0P_1_1+ C1*sum1Re_0P_1_1)
                  )
              + C_R_plus*sqrt_chk(C_S_plus_square)  *( 

                  ( C1*sum1Im_P11 +  C3*sum3Im_P11)*( C1*sum1Im_0P11 +  C3*sum3Im_0P11)
                  +  ( C1*sum1Im_P_11 + C3*sum3Im_P_11)*( C1*sum1Im_0P_11 + C3*sum3Im_0P_11)
                  +  ( C1*sum1Im_P1_1 + C3*sum3Im_P1_1)*( C1*sum1Im_0P1_1 + C3*sum3Im_0P1_1)
                  +  ( C1*sum1Im_P_1_1 +C3*sum3Im_P_1_1)*( C1*sum1Im_0P_1_1 +C3*sum3Im_0P_1_1)

                  +   ((F_plus11   - G_plus11  ) + C3*sum3Re_P11  + C1*sum1Re_P11) * ((F_zero_plus11   - G_zero_plus11  ) + C3*sum3Re_0P11  + C1*sum1Re_0P11) 
                  +   ((F_plus_11  - G_plus_11 ) + C3*sum3Re_P_11 + C1*sum1Re_P_11)* ((F_zero_plus_11  - G_zero_plus_11 ) + C3*sum3Re_0P_11 + C1*sum1Re_0P_11)
                  +   ((F_plus1_1  - G_plus1_1 ) + C3*sum3Re_P1_1 + C1*sum1Re_P1_1 )*((F_zero_plus1_1  - G_zero_plus1_1 ) + C3*sum3Re_0P1_1 + C1*sum1Re_0P1_1 ) 
                  +   ((F_plus_1_1 - G_plus_1_1) + C3*sum3Re_P_1_1+ C1*sum1Re_P_1_1)*((F_zero_plus_1_1 - G_zero_plus_1_1) + C3*sum3Re_0P_1_1+ C1*sum1Re_0P_1_1)
                  )
              ...
              +2.*sin(phi)*(        
                  - C_L_minus*sqrt_chk(C_S_minus_square)*( 
                    ...
                    ( C1*sum1Im_M11 +  C3*sum3Im_M11)*((F_zero_minus11   - G_zero_minus11  ) + C3*sum3Re_0M11  + C1*sum1Re_0M11)
                    +  ( C1*sum1Im_M_11 + C3*sum3Im_M_11)*((F_zero_minus_11  - G_zero_minus_11 ) + C3*sum3Re_0M_11 + C1*sum1Re_0M_11)
                    +  ( C1*sum1Im_M1_1 + C3*sum3Im_M1_1)*((F_zero_minus1_1  - G_zero_minus1_1 ) + C3*sum3Re_0M1_1 + C1*sum1Re_0M1_1 )
                    +  ( C1*sum1Im_M_1_1 +C3*sum3Im_M_1_1)*((F_zero_minus_1_1 - G_zero_minus_1_1) + C3*sum3Re_0M_1_1+ C1*sum1Re_0M_1_1)

                    -   ((F_minus11   - G_minus11  ) + C3*sum3Re_M11 + C1*sum1Re_M11)*( C1*sum1Im_0M11 +  C3*sum3Im_0M11)                 
                    -   ((F_minus_11  - G_minus_11 ) + C3*sum3Re_M_11+ C1*sum1Re_M_11)*( C1*sum1Im_0M_11 + C3*sum3Im_0M_11)
                    -   ((F_minus1_1  - G_minus1_1 ) + C3*sum3Re_M1_1+ C1*sum1Re_M1_1)*( C1*sum1Im_0M1_1 + C3*sum3Im_0M1_1)                 
                    -   ((F_minus_1_1 - G_minus_1_1) + C3*sum3Re_M_1_1+C1*sum1Re_M_1_1)*( C1*sum1Im_0M_1_1 +C3*sum3Im_0M_1_1)                 
                    )

                  + C_R_minus*sqrt_chk(C_S_minus_square)  *( 

                    ( C1*sum1Im_P11 +  C3*sum3Im_P11)*((F_zero_minus11   - G_zero_minus11  ) + C3*sum3Re_0M11  + C1*sum1Re_0M11)
                    +  ( C1*sum1Im_P_11 + C3*sum3Im_P_11)*((F_zero_minus_11  - G_zero_minus_11 ) + C3*sum3Re_0M_11 + C1*sum1Re_0M_11)
                    +  ( C1*sum1Im_P1_1 + C3*sum3Im_P1_1)*((F_zero_minus1_1  - G_zero_minus1_1 ) + C3*sum3Re_0M1_1 + C1*sum1Re_0M1_1 )
                    +  ( C1*sum1Im_P_1_1 +C3*sum3Im_P_1_1)*((F_zero_minus_1_1 - G_zero_minus_1_1) + C3*sum3Re_0M_1_1+ C1*sum1Re_0M_1_1)

                    -   ((F_plus11   - G_plus11  ) + C3*sum3Re_P11  + C1*sum1Re_P11) *( C1*sum1Im_0M11 +  C3*sum3Im_0M11)                    
                    -   ((F_plus_11  - G_plus_11 ) + C3*sum3Re_P_11 + C1*sum1Re_P_11)*( C1*sum1Im_0M_11 + C3*sum3Im_0M_11)                   
                    -   ((F_plus1_1  - G_plus1_1 ) + C3*sum3Re_P1_1 + C1*sum1Re_P1_1 )*( C1*sum1Im_0M1_1 + C3*sum3Im_0M1_1)                   
                    -   ((F_plus_1_1 - G_plus_1_1) + C3*sum3Re_P_1_1+ C1*sum1Re_P_1_1)*( C1*sum1Im_0M_1_1 +C3*sum3Im_0M_1_1)                  
                    )

                  - C_L_plus*sqrt_chk(C_S_plus_square)*( 

                      ( C1*sum1Im_M11 +  C3*sum3Im_M11)*((F_zero_plus11   - G_zero_plus11  ) + C3*sum3Re_0P11  + C1*sum1Re_0P11)
                      +  ( C1*sum1Im_M_11 + C3*sum3Im_M_11)*((F_zero_plus_11  - G_zero_plus_11 ) + C3*sum3Re_0P_11 + C1*sum1Re_0P_11)
                      +  ( C1*sum1Im_M1_1 + C3*sum3Im_M1_1)*((F_zero_plus1_1  - G_zero_plus1_1 ) + C3*sum3Re_0P1_1 + C1*sum1Re_0P1_1 )
                      +  ( C1*sum1Im_M_1_1 +C3*sum3Im_M_1_1)*((F_zero_plus_1_1 - G_zero_plus_1_1) + C3*sum3Re_0P_1_1+ C1*sum1Re_0P_1_1)

                      -   ((F_minus11   - G_minus11  ) + C3*sum3Re_M11 + C1*sum1Re_M11)*( C1*sum1Im_0P11 +  C3*sum3Im_0P11)
                      -   ((F_minus_11  - G_minus_11 ) + C3*sum3Re_M_11+ C1*sum1Re_M_11)*( C1*sum1Im_0P_11 + C3*sum3Im_0P_11)                  
                      -   ((F_minus1_1  - G_minus1_1 ) + C3*sum3Re_M1_1+ C1*sum1Re_M1_1)*( C1*sum1Im_0P1_1 + C3*sum3Im_0P1_1)                  
                      -   ((F_minus_1_1 - G_minus_1_1) + C3*sum3Re_M_1_1+C1*sum1Re_M_1_1)*( C1*sum1Im_0P_1_1 +C3*sum3Im_0P_1_1)                  
                      )

                  + C_R_plus*sqrt_chk(C_S_plus_square)*( 

                      ( C1*sum1Im_P11 +  C3*sum3Im_P11)*((F_zero_plus11   - G_zero_plus11  ) + C3*sum3Re_0P11  + C1*sum1Re_0P11)
                      +  ( C1*sum1Im_P_11 + C3*sum3Im_P_11)*((F_zero_plus_11  - G_zero_plus_11 ) + C3*sum3Re_0P_11 + C1*sum1Re_0P_11)
                      +  ( C1*sum1Im_P1_1 + C3*sum3Im_P1_1)*((F_zero_plus1_1  - G_zero_plus1_1 ) + C3*sum3Re_0P1_1 + C1*sum1Re_0P1_1 )
                      +  ( C1*sum1Im_P_1_1 +C3*sum3Im_P_1_1)*((F_zero_plus_1_1 - G_zero_plus_1_1) + C3*sum3Re_0P_1_1+ C1*sum1Re_0M_1_1)

                      -   ((F_plus11   - G_plus11  ) + C3*sum3Re_P11  + C1*sum1Re_P11) *( C1*sum1Im_0P11 +  C3*sum3Im_0P11)                    
                      -   ((F_plus_11  - G_plus_11 ) + C3*sum3Re_P_11 + C1*sum1Re_P_11)*( C1*sum1Im_0P_11 + C3*sum3Im_0P_11)                  
                      -   ((F_plus1_1  - G_plus1_1 ) + C3*sum3Re_P1_1 + C1*sum1Re_P1_1 )*( C1*sum1Im_0P1_1 + C3*sum3Im_0P1_1)                   
                      -   ((F_plus_1_1 - G_plus_1_1) + C3*sum3Re_P_1_1+ C1*sum1Re_P_1_1)*( C1*sum1Im_0P_1_1 +C3*sum3Im_0P_1_1)                  
                      )
                  ...
                  + 2.*cos(2.*phi) * C_LR*(
                      ...
                      +   ((F_minus11   - G_minus11  ) + C3*sum3Re_M11 + C1*sum1Re_M11)*((F_plus11   - G_plus11  ) + C3*sum3Re_P11  + C1*sum1Re_P11)
                      +   ((F_minus_11  - G_minus_11 ) + C3*sum3Re_M_11+ C1*sum1Re_M_11)*((F_plus_11  - G_plus_11 ) + C3*sum3Re_P_11 + C1*sum1Re_P_11)
                      +   ((F_minus1_1  - G_minus1_1 ) + C3*sum3Re_M1_1+ C1*sum1Re_M1_1)*((F_plus1_1  - G_plus1_1 ) + C3*sum3Re_P1_1 + C1*sum1Re_P1_1 )
                      +   ((F_minus_1_1 - G_minus_1_1) + C3*sum3Re_M_1_1+C1*sum1Re_M_1_1)*((F_plus_1_1 - G_plus_1_1) + C3*sum3Re_P_1_1+ C1*sum1Re_P_1_1)
                      )

                  - 2.*sin(2.*phi) *C_LR *( 

                      ( C1*sum1Im_M11 +  C3*sum3Im_M11)*((F_plus11   - G_plus11  ) + C3*sum3Re_P11  + C1*sum1Re_P11)
                      +  ( C1*sum1Im_M_11 + C3*sum3Im_M_11)*((F_plus_11  - G_plus_11 ) + C3*sum3Re_P_11 + C1*sum1Re_P_11)
                      +  ( C1*sum1Im_M1_1 + C3*sum3Im_M1_1)*((F_plus1_1  - G_plus1_1 ) + C3*sum3Re_P1_1 + C1*sum1Re_P1_1 )
                      +  ( C1*sum1Im_M_1_1 +C3*sum3Im_M_1_1)*((F_plus_1_1 - G_plus_1_1) + C3*sum3Re_P_1_1+ C1*sum1Re_P_1_1)

                      -   ((F_minus11   - G_minus11  ) + C3*sum3Re_M11 + C1*sum1Re_M11)*( C1*sum1Im_P11 +  C3*sum3Im_P11)                 
                      -   ((F_minus_11  - G_minus_11 ) + C3*sum3Re_M_11+ C1*sum1Re_M_11)*( C1*sum1Im_P_11 + C3*sum3Im_P_11)
                      -   ((F_minus1_1  - G_minus1_1 ) + C3*sum3Re_M1_1+ C1*sum1Re_M1_1)*( C1*sum1Im_P1_1 + C3*sum3Im_P1_1)                 
                      -   ((F_minus_1_1 - G_minus_1_1) + C3*sum3Re_M_1_1+C1*sum1Re_M_1_1)*( C1*sum1Im_P_1_1 +C3*sum3Im_P_1_1)                  
                      )

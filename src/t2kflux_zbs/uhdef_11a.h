...
#ifndef FH2H_UHDEF_11A_FH_FOR_FH2H
#define FH2H_UHDEF_11A_FH_FOR_FH2H
...
/*common nufd10b was here*/

/*data statement for nufdtags10b was here*/

/*common nufd11a was here*/

/*data statement for nufdtags11a was here*/
...
#ifndef NO_EXTERN_COMMON_POINTERS
extern struct nufd10b_common *nufd10b;
#endif
#ifdef STATIC_COMMON_POINTERS
static struct nufd10b_common *nufd10b = &nufd10b_;
#endif

extern struct nufd11a_common {
  int    gmatfd[25];
  float  gdistcfd[25];
  float  gdistalfd[25];
  float  gdisttifd[25];
...
#ifndef NO_EXTERN_COMMON_POINTERS
extern struct nufd11a_common *nufd11a;
#endif
#ifdef STATIC_COMMON_POINTERS
static struct nufd11a_common *nufd11a = &nufd11a_;
#endif
...
static char   *nufdtags[8] = {            "Enu:R             , ppid:I            , mode:I            , ",       "ppi:R             , xpi(3):R          , npi(3):R          , ",       "cospibm:R         , norm:R            , nvtx0:I           , ",       "ppi0:R            , xpi0(3):R         , npi0(3):R         , ",       "cospi0bm:R        , rnu:R             , xnu:R             , ",       "ynu:R             , nnu(3):R          , idFD:I            , ",       "gipart[0, 100]:I   , gpos0(3):R        , gvec0(3):R        , ",       "gamom0:R "};
...
#define NUFDTAGS10B_MAX_LENGTH (60)
static char   *nufdtags10b[5] = {      "ng:I::[0, 25]      , gpx(ng):R         , gpy(ng):R         , ",       "gpz(ng):R         , gcosbm(ng):R      , gvx(ng):R         , ",       "gvy(ng):R         , gvz(ng):R         , gpid(ng):I        , ",       "gmec(ng):I        , EnuSK:R           , normSK:R          , ",       "anorm:R "};

#define NUFDTAGS11A_MAX_LENGTH (60)
static char   *nufdtags11a[2] = {      "gmat(ng):I        , gdistc(ng):R      , gdistal(ng):R     , ",        "gdistti(ng):R     , gdistfe(ng):R  "};
...
#endif  /* #ifndef FH2H_UHDEF_11A_FH_FOR_FH2H */
